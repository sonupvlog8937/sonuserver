...
const userSchema = mongoose.Schema({
    ...
    role: {
        type: String,
        enum: ['ADMIN', 'VICE_ADMIN', 'USER', 'SELLER', 'GROCERY_SELLER', 'RESTAURANT_SELLER', 'FASHION_SELLER', 'ELECTRONICS_SELLER', 'MEDICAL_SELLER', 'BEAUTY_SELLER', 'HOME_KITCHEN_SELLER', 'GIFTS_TOYS_SELLER', 'BOOKS_STATIONERY_SELLER', 'JEWELLERY_SELLER', 'HARDWARE_SELLER', 'AUTOMOBILE_SELLER', 'DELIVERY_RIDER'],
        default: "USER"
    },
    signUpWithGoogle:{
        type:Boolean,
