...
orderRouter.get("/order-list",auth,authorizeRole('ADMIN','VICE_ADMIN'),getOrderDetailsController)
...
orderRouter.put('/order-status/:id',auth,authorizeRole('ADMIN','VICE_ADMIN',...ALL_SELLER_ROLES),updateOrderStatusController)
orderRouter.get('/count',auth,authorizeRole('ADMIN','VICE_ADMIN'),getTotalOrdersCountController)
orderRouter.get('/sales',auth,authorizeRole('ADMIN','VICE_ADMIN'),totalSalesController)
orderRouter.get('/users',auth,authorizeRole('ADMIN','VICE_ADMIN'),totalUsersController)
...
orderRouter.put('/user/cancel/:id', auth, cancelUserOrderController)
